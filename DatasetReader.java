...
public class DatasetReader {
    public static void main(String[] args) {
        ...
        try {
            ...
            Object obj = parser.parse(new FileReader("C:\\Users\\engin\\Desktop\\CES3063F20_LabelingProject_Input-2.json"));
            ...
            for (int i=0; i<jsonArrayForInstances.size(); i++) { //assigns the given instances in the input to the instances array
                ...
                String instance = (String) obj2.escape((String) obj2.get("instance"));
                instances[i] = new Instance(instanceId, instance);
            }

            System.out.println(instances[2].instance);
